...
class TwistedEdwardsCurve(ProjectiveCurve_generic):
    ...
    def to_weierstrass_morphism(self):
        """ 
        Returns a morphism from this Edwards curve to the associated elliptic 
    ...
    def from_weierstrass_map(self):
        """
        Returns a morphism from the associated elliptic curve on Weierstrass
        form to this Edwards curve.
        """
